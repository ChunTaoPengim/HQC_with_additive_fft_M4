...
int crypto_kem_keypair(uint8_t *ek_kem, uint8_t *dk_kem) {
    ...
    PQCLEAN_HQC128_CLEAN_hqc_pke_keygen(ek_pke, dk_pke, seed_pke);
...
int crypto_kem_enc(uint8_t *c_kem, uint8_t *K, const uint8_t *ek_kem) {
    ...
    PQCLEAN_HQC128_CLEAN_hqc_pke_encrypt(&c_kem_t.c_pke, ek_kem, (uint64_t *)m, theta);
...
int crypto_kem_dec(uint8_t *K_prime, const uint8_t *c_kem, const uint8_t *dk_kem) {
    ...
    result = PQCLEAN_HQC128_CLEAN_hqc_pke_decrypt((uint64_t *)m_prime, dk_pke, &c_kem_t.c_pke);
    ...
    PQCLEAN_HQC128_CLEAN_hqc_pke_encrypt(&c_kem_prime_t.c_pke, ek_pke, (uint64_t *)m_prime, theta_prime);

...
void PQCLEAN_HQC192_CLEAN_vect_mul_2(uint64_t *u, uint64_t* tmp2, const uint64_t *r2, const uint64_t *h, const uint64_t *s){

	uint32_t h_fft[65536 / 32] = {0};
    uint32_t s_fft[65536 / 32] = {0};
    uint32_t r2_fft[65536 / 32] = {0};

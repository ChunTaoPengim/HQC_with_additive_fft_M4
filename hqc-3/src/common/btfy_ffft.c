...
void btfy_65536( uint32_t * poly )
{
  ...
  gft_mul_vi[0] = gft_mul_s_inv_11_beta;
  gft_mul_vi[1] = gft_mul_s_inv_10_beta;
  gft_mul_vi[2] = gft_mul_s_inv_9_beta;
  gft_mul_vi[3] = gft_mul_s_inv_8_beta;
  gft_mul_vi[4] = gft_mul_s_inv_7_beta;
  gft_mul_vi[5] = gft_mul_s_inv_6_beta;
  gft_mul_vi[6] = gft_mul_s_inv_5_beta;
  gft_mul_vi[7] = gft_mul_s_inv_4_beta;
  gft_mul_vi[8] = gft_mul_s_inv_3_beta;
  gft_mul_vi[9] = gft_mul_s_inv_2_beta;
  gft_mul_vi[10] = gft_mul_s_inv_1_beta;
